...
const ZONES = [
  ...
  // ─── Inner Bay & Harbor Zones — Southern California ───
  {
    name: "San Diego Bay",
    slug: "san-diego-bay",
    waterType: "SALT" as const,
    ...
    tideStationId: "9410170",
    ndbcBuoyId: "46232",
    species: ["Halibut", "Calico Bass", "White Seabass", "Yellowtail"],
  },
  {
    name: "Mission Bay",
    slug: "mission-bay",
    ...
    tideStationId: "9410170",
    ndbcBuoyId: "46232",
    species: ["Halibut", "Calico Bass", "White Seabass"],
  },
  {
    name: "Encinitas",
    slug: "encinitas",
    ...
    ndbcBuoyId: "46224",
    species: ["Yellowtail", "Calico Bass", "Halibut", "White Seabass"],
  },
  {
    name: "Carlsbad",
    slug: "carlsbad",
  ...
  },
  {
    ...
    lon: -118.27,
    radiusMiles: 10,
    tideStationId: "9410665",
    ndbcBuoyId: null,
    species: ["Halibut", "White Seabass", "Calico Bass", "Yellowtail"],
  },
  {
    name: "Long Beach Harbor",
    slug: "long-beach-harbor",
    waterType: "SALT" as const,
    lat: 33.75,
    lon: -118.21,
    radiusMiles: 10,
